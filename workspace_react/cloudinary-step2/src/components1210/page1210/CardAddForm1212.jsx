...
const CardAddForm1212 = ({ FileInput, onAdd }) => {
  ...
  const onSubmit = (event) => {
    //이벤트 전이 막기 - button태그는 디폴트가 submit속성을 가진다. - 그래서 화면이 새로고침일어난다. -이것을 막아준다.
    ...
    formRef.current.reset();// 즉 사용자가 입력해서 제출하고 나면 폼이다 리셋되도록 이렇게 해준다.
    console.log(card);//새로 추가되는 카드정보 담김 - Maker.jsx에서 63번라인에 출력된다.
    // card에 추가한 뒤 즉 Add버튼 누른다음 파일정보 초기화 해준다.
